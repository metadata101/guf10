...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  prefixed by #.
        -->
  <xsl:function name="gn-fn-guf10:getLangId" as="xs:string">
    <xsl:param name="md"/>
    <xsl:param name="lang"/>
  ...
  <xsl:function name="gn-fn-guf10:getCodeListType" as="xs:string">
  ...
  <!--
   ...
   -->
  <xsl:function name="gn-fn-guf10:fillTextElement" as="node()*">
    <xsl:param name="string" as="xs:string"/>
    <xsl:param name="mainLanguage" as="xs:string"/>
    <xsl:param name="useOnlyPTFreeText" as="xs:boolean"/>

    <xsl:copy-of select="gn-fn-guf10:fillTextElement($string, '\|', '#', $mainLanguage, $useOnlyPTFreeText)"/>
  </xsl:function>
